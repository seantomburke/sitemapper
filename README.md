...
### Examples in ES6
```javascript
import Sitemapper from 'sitemapper'; // or const Sitemapper = require('sitemapper');
...
See [axios config](https://github.com/axios/axios/blob/master/README.md#request-config) for all Options
